    ...
    function dashboard() {
        return {
            ...
            globalSettings: {
                ...
                model: { model_dirs: [''] },
                memory: { prefill_memory_guard: true, abort_under_pressure: true, memory_guard_tier: 'balanced', memory_guard_custom_ceiling_gb: 0 },
                ...
                try {
                    const response = await fetch('/admin/api/global-settings', {
                        ...
                        body: JSON.stringify({
                            ...
                            memory_abort_under_pressure: this.globalSettings.memory.abort_under_pressure,
